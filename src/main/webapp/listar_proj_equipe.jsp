...
<html>
    ...
    <body>
        ...
        <div class="container" >
            ...
            <div class="content">      
                <div id="equipe">
                    <form name="listar_funcionario" method="get" action="listar_proj_eqp.jsp"> 
                        <h1>Lista de Projetos</h1>
                        <p>
                            <label>Departamento</label>
                            <input type="text" class="form-control" name="departamento" required="required" value=""/>
                        </p>
                        
                        <p>
                            <label>Nome da Equipe</label>
                            <input type="text" class="form-control" name="equipe" required="required" value=""/>
                        </p>
