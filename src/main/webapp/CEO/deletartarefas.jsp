...
<html>
    ...
    <body>
        ...
        <div class="container" >
            ...
            <div class="content">      
                <div id="tarefa">
                    <form name="formDeletarTarefa" method="post" action="deletar_tarefa.jsp"> 
                        ...
                        <p>
                            <label>Nome da Tarefa a ser Deletada</label>
                            <input type="text" class="form-control" name="tarefa_deletada" value=""/>
                        </p>
                        <div class="form-row">
