...
<html>
    ...
    <body>
        ...
        <div class="container" >
            <a class="links" id="paradepartamento"></a>
            <div class="content">      
                <div id="departamento">
                    <form name="formGerarDepartamento" method="post" action="salvar_dep.jsp"> 
                        ...
                        <div class="col-4 offset-md-4">
                            ...
                            if (erro != null){
                                if (erro.equals("falhou")){
                                    %>
                                    Falhou ao criar departamento
                                    <%
                                }
                            }   
                            %>
...
<style>
    ...
    #paradepartamento:target ~ .content #departamento{
    z-index: 2;
