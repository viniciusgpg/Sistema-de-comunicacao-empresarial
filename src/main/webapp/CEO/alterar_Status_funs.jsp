...
<html>
    ...
    <body>
        ...
        <div class="container" >
            ...
            <div class="content">      
                <div id="remover">
                    <form name="removerFuncionario" method="post"  action="alterar_Status_fun.jsp"> 
                        <h1>Alterar Status do Funcionario</h1> 
                        <p>
                        ...
                        <div class="col-md-6">
                            ...
                            %>
                            <input type="submit" class="btn btn-primary mb-2 corbotao" name="removerFuncionario" value="Alterar">
                        </div>
                    </form>
                </div>
            </div>
