...
<html>
    <head>
        ...
        <title>Atribuir Equipe Projeto</title>
    </head>
    <body>
        <header>
        ...
        <div class="container" >
            <a class="links" id="pjtreqp"></a>
            <div class="content">      
                <div id="pjeq">
                    <form name="formCriarProjeto" method="post" action="atribuir_equipe_proj.jsp"> 
                        <h1>Atribuir Equipe a um Projeto</h1> 
                        <p>
                        ...
                        <p>
                            ...
                            <input type="text" class="form-control" name="equipe" value=""/>
                        </p>
                        <div class="col-md-4">
                            ...
                            if (erro != null){
                                if (erro.equals("N_EQUIPE")){
                                 ...
                                 else if(erro.equals("N_PROJ")){
                                  %>
                                   Não achou Projeto
                                  <%
                                }
                                 else if(erro.equals("N_BANCO")){
                                  %>
