...
<html>
    ...
    <body>
        ...
        <div class="container" >
            <a class="links" id="paraequipe"></a>
            <div class="content">      
                <div id="equipe">
                    <form name="formGerarDepartamento" method="post" action="salvar_equipe.jsp"> 
                        <h1>Criar Equipe</h1>
                        
                        <p>
                            <label>Nome da Equipe</label>
                            <input type="text" class="form-control" name="nome_equipe" value=""/>
                        </p>
                        <p>
                            <label>Representante da Equipe</label>
                            <input type="text" class="form-control" name="representante" value=""/>
                        </p>
...
<style>
    ...
    #paraequipe:target ~ .content #equipe{
    z-index: 2;
