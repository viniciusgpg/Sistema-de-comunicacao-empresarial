                ...
                <div id="cdtfun">
                    <form method="post" action="salvar.jsp"> 
                        ...
                        <p> 
                            ...
                            <input name="Departamento" class="form-control" required="required" type="text"/>
                        </p>
                        <p> 
                            <label>RG</label>
                        ...
                        <p> 
                            <label>Senha</label>
                            <input name="senha" class="form-control" required="required" type="password" placeholder="Digite a senha"/>
                        </p>
                        <p> 
                            <label>Confirmar Senha</label>
                            <input name="confirmar_senha" class="form-control" required="required" type="password"/>
                        </p>
                        <p> 
                            <label>Email</label>
                        ...
                        <p>
                            <input name="Gerente" class="form-check-input" class="form-control" required="required" type="checkbox"/>
                            <label>Selecione se for um Gerente</label>
                        </p>
                        <div class="col-md-6">
