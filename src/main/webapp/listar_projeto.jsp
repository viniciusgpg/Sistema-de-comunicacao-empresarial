    ...
    <header>
        ...
        <div class="container" >
            <a class="links" id="paraatrbuit"></a>
                <div class="content">      
                    <div id="dalma">
                        <form name="formListarEquipe" method="get" action="listar_proj.jsp"> 
                            <h1>Listar  Projetos Ativos</h1>
                            <p> 
                                <label>Nome do Departamento</label>
                                <input id="nome_login" name="departamento"  value="" class="form-control" required="required" type="text"/>
                            </p>       
                            <p>
                            <input name="Ativo" class="form-check-input" class="form-control"  type="checkbox"/>
                            <label>Selecione os Projetos Inativos</label>
                        </p>
                            <div class="col-md-4">
                            <%
