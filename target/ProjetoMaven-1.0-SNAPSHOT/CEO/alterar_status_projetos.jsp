...
<html>
    <head>
        ...
        <title>Alterar Status Projeto</title>
    </head>
    <body>
        <header>
        ...
        <div class="container" >
            ...
            <div class="content">      
                <div id="deletar">
                    <form name="formCadastroFuncionario" method="post" action="alterarStatusProjeto.jsp"> 
                        ...
                        <p>
                           ...
                           <input type="text" class="form-control" name="projeto" value=""/>
                        </p>
                        <div class="">
                            ...
                            if (erro != null){
                                if (erro.equals("N_EQUIPE")){
                                    %>
                                    Não encontrou equipe
                                    <%
                                }
                            }   
                            %>
                            <input type="submit" class="btn btn-primary mb-2 corbotao" name="salvar" value="Alterar">
                        </div>
                    </form>
                </div>
            </div>
