                            ...
                            if(ceo==null){
                                ...
                                if(ger==null){
                                    ...
                                    if(fun==null){
                                        ...
                                        ArrayList<Projeto>projs=CEOBD.Listar_projeto_funcionario(fun.getEmail(), ativo);
                                        %>
                                    ...
                                    ArrayList<Projeto>projs=CEOBD.Listar_projeto(ger.getID_departamento(), ativo);
                                    %>
                                       <table class="tabletest2">
                                    <%                                    
                                    for(int i=0;i<projs.size();i++){
                                ...
                                if(id_dep!=null){
                                    ArrayList<Projeto>projs=CEOBD.Listar_projeto(id_dep, ativo);
                                    %>
                                       <table class="tabletest2">
                                    <%                                    
                                    for(int i=0;i<projs.size();i++){
