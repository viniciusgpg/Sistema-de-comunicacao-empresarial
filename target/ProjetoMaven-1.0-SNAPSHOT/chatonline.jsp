                ...
                <div class="panel panel-primary">
                    <div class="panel-heading">
                      ...
                      if(ceo==null){
                          ...
                          if(ger==null){
                             ...
                             if(fun==null){
                                 %>
                                 <li><a href="http://sistema-empresarial.herokuapp.com/index.jsp"></a></li>
                                 <%
                             }
                             else{%>
                               <li><a href="http://sistema-empresarial.herokuapp.com/Menu_Funcionario.jsp"><span class="glyphicon glyphicon-off"></span>Sair</a></li>
                               <%
                                   }
                          }else{
                            %>
                               <li><a href="http://sistema-empresarial.herokuapp.com/Menu_Gerente.jsp"><span class="glyphicon glyphicon-off"></span>Sair</a></li>
                               <%
                            }
                      }else{
                            %>
                               <li><a href="http://sistema-empresarial.herokuapp.com/Menu_CEO.jsp"><span class="glyphicon glyphicon-off"></span>Sair</a></li>
                               <%
                                   }
                      %>
                    ...
                    <div class="panel-footer">
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control input-sm chat-entry" placeholder="Digite sua mensagem">
                        </div>
                    </div>
