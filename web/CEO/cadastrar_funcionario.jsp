                ...
                <div id="cdtfun">
                    <form method="post" action="salvar_gerente.jsp"> 
                       ...
                       <input id="telefone_cad" name="telefone" class="form-control" required="required" type="int" placeholder="Digite seu telefone"/>
                        ...
                        <p>
                            <input name="Gerente" class="form-check-input" class="form-control"  type="checkbox"/>
                        ...
                        <div class="col-md-6">
                            ...
                            if (erro != null){
                                ...
                                <%
                                }else if(erro.equals("DEP_N_EXISTE")){
                                %>
                                O Departamento não existe. Tente novamente
                                <%
                                }else if(erro.equals("Email_existe")){ 
                                %>
                                Email já existe. Tente novamente
                                <%
                                }
