...
<html>
    ...
    <body>
        ...
        if(nome.equals("")||nome_empresa.equals("")||senha.equals("")||confirma.equals("")||email.equals("")||telefone.equals("")){
           response.sendRedirect("https://sistema-empresarial.herokuapp.com/CEO/cadastro.jsp?erro=CAMPO_VAZIO");
        }else if(CEOBD.validarEmail(email)){
            response.sendRedirect("https://sistema-empresarial.herokuapp.com/CEO/cadastro.jsp?erro=EMAIL_EXISTE");
        }else{
            ...
            if(senha.equals(confirma)){
                ...
                ceo.setSenha(senha);
                CEOBD.Inserir(ceo);
                response.sendRedirect("https://sistema-empresarial.herokuapp.com?cadsstro=SUCESSO");
            }else{
                System.out.println("Não Entro");
                response.sendRedirect("https://sistema-empresarial.herokuapp.com/CEO/cadastro.jsp?erro=SENHA_ERRADA");
            }
        }
        %>
