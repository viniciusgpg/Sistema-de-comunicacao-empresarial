...
public class CEOBD  {
    ...
    public static void Inserir(CEO ceoNew){
        ...
        String connectionUrl =
                "jdbc:sqlserver://projsofsge.database.windows.net:1433;databaseName=WebSof [SGE_@projsofsge em db_datawriter];"
                        + "database=WebSof;"
                        + "user=SGE_@projsofsge;"
    ...
    String connectionUrl =
                "jdbc:sqlserver://projsofsge.database.windows.net:1433;"
                        + "database=WebSof;"
                        + "user=SGE_@projsofsge;"
                        + "password=Calebeodeiadualboot2020_;"
                        + "encrypt=true;"
